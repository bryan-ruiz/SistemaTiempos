...
public class TicketWindowPrint extends javax.swing.JFrame {
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        ...
        if (tab2.getRowCount() > 0) {
            ...
            printitem =ps.getTableData(jTable1,ticketTxt.getText(),storeTxt.getText(),timeTxt.getText(),initialDate, hourTxt.getText(),
                    -1, totalMoneyTxt.getText());
            ps.setItems(printitem);
